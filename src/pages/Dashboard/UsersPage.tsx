...
import { PlusCircle, Edit, Trash2, User, Shield, Crown } from "lucide-react";
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid gap-4 py-4">
              <div className="space-y-2">
                ...
                <Input id="full_name" name="full_name" value={formData.full_name} onChange={handleFormChange} disabled={!!editingUser} />
              </div>
              <div className="space-y-2">
