...
import { Menu, LayoutDashboard, Package, ShoppingCart, Database, FileText, Users, UserCircle, Receipt, Wrench, CreditCard, ChevronDown, ClipboardPlus, Truck, Info } from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  { 
    ...
    subItems: [
        { name: "Info Service", icon: Info, path: "/dashboard/service-masuk" },
    ]
  },
  { 
    name: "Transaksi", 
