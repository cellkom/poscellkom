...
const PublicLayout = ({ children }: { children: ReactNode }) => {
  ...
  const navLinks = [
    ...
    { name: "Berita", href: "/news", icon: Newspaper }, // New: Berita menu
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur-sm">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
          ...
          <div className="flex items-center gap-2">
            {/* ThemeToggle is not defined in this snippet, assuming it's imported elsewhere */}
            {/* <ThemeToggle /> */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link to="/news" className="hover:text-primary transition-colors">Berita</Link></li> {/* New: Berita link in footer */}
